    ...
    <div className="login-container">
      ...
      <div className="login-card">
        ...
        <div className="login-body">
            ...
            <div className="role-cards">
              ...
              >
                ...
                <span className="role-card__desc">
                  Enter a code to access & download study materials
                </span>
              ...
              <button
                type="button"
                className={`role-card ${
                  selectedRole === 'faculty' ? 'role-card--active' : ''
                }`}
                onClick={() => {
              ...
              >
                ...
                <span className="role-card__desc">
                  Upload files & generate access codes for students
                </span>
          ...
          <button
            className={`google-btn ${
              !selectedRole ? 'google-btn--disabled' : ''
            }`}
          ...
          >
            {loading ? (
              <>
                <div className="google-btn__spinner"></div>
        ...
        <div className="login-footer">
          <p>© 2026 StudyShala. All rights reserved.</p>
        </div>
      </div>
    </div>
  );
